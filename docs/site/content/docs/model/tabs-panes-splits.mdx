...
- An active-tab color bar marks which pane is focused. Terminal headers tint by launched agent (Claude orange, Pi blue, named Piw profile purple) or dev/custom command (teal); ordinary terminals stay neutral. Right-click a terminal tab to choose a manual swatch, **Automatic**, or **No color**.
